...
REPO = "visaodeempresa/mw-ha-state-color-element"          # dono/repositório no GitHub
NOME = "mw-ha-state-color-element"                    # a pasta em /config/www/community
CARD = "mw-state-color-element"                    # o arquivo .js, sem extensão
